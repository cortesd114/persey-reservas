...
<head>
    ...
    <title>Estado de Espacios</title>
...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                ...
                                <p>
                                    <b>Crear y modificar el estado de los espacios.</b>
                                </p>
                                <div class="text-end">
                                    <button type="button" id="nuevoRegistro" class="btn btn-success"
                                        style="padding: 9px;">Nuevo</button>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            ...
                                            <input type="hidden" id="idEstadoEspacios">
                                            <h3 class="text-uppercase">Guardar Estado De Espacio</h3>
                                            <p><b>Guardar Estado Espacio</b></p>
                                        </div>
                                        <div class="panel-body panel-block">
                                            <div class="panel panel-default">
                                                <div style="justify-items: end" id="formGuardarEstadoEspacios">
    ...
    <script src="{{ asset('js/estadoEspacios.js') }}"></script>
